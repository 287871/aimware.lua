    ...
    return t;
        ...
        callbacks.Register("Draw", "getTime", function()
            ...
            if sTime == 0 or ((sTime + 1200 < common.Time()) and (entities.GetLocalPlayer() == nil or not entities.GetLocalPlayer():IsAlive())) then
                local data = http.Get("https://time.is/Beijing");
                if data ~= nil then
...
qiskaiindicatorWindow = gui.Window("qiskaiindicator", "aimware指示器", 100, 300, 300, 200);
function qiskaiindicator_Window()
...
function DrawUI()
keybindlist = gui.Checkbox(qiskaiindicatorWindow,"keybindlist","Show Keybinds",1);
keybindlist:SetDescription("Shows a list of active keybinds.");
kcolorPicker = gui.ColorPicker(keybindlist, "kmainCol", "Main Colour", 255,0,0,255)
kcolorPicker2 = gui.ColorPicker(keybindlist, "ktextCol", "Text Colour", 255, 255, 255, 255)
kcolorPicker3 = gui.ColorPicker(keybindlist, "kbgCol", "Bg Colour", 0,0,0,100) 
